 ...
 */
// tested
Circle2<Real> Circle2<Real>::from_points_unchecked(
 ...
 */
// tested
std::optional<Circle2<Real>> Circle2<Real>::from_points(
    const Point2<Real>& point1, const Point2<Real>& point2, const Point2<Real>& point3)
{
    const Point2<Real> mid12 = nnm::Segment2<Real> { point1, point2 }.midpoint();
    const Point2<Real> mid23 = nnm::Segment2<Real> { point2, point3 }.midpoint();
 ...
 */
// tested
[[nodiscard]] constexpr Segment2<Real> Triangle2<Real>::edge(const int index) const
{
 ...
 */
// tested
[[nodiscard]] std::optional<Point2<Real>> Triangle2<Real>::circumcenter() const
{
 ...
 */
// tested
[[nodiscard]] std::optional<Point2<Real>> Triangle2<Real>::orthocenter() const
{
 ...
 */
// tested
[[nodiscard]] constexpr Segment2<Real> Triangle2<Real>::median(const int index) const
{
    NNM_BOUNDS_CHECK_ASSERT("Triangle2<Real>", index >= 0 && index <= 2);
    const int next_index = (index + 1) % 3;
 ...
 */
// tested
[[nodiscard]] Line2<Real> Triangle2<Real>::perpendicular_bisector(const int index) const
{
    NNM_BOUNDS_CHECK_ASSERT("Triangle2<Real>", index >= 0 && index <= 2);
 ...
 */
// tested
[[nodiscard]] Line2<Real> Triangle2<Real>::angle_bisector(const int index) const
{
    NNM_BOUNDS_CHECK_ASSERT("Triangle2<Real>", index >= 0 && index <= 2);
    const int next_index = (index + 1) % 3;
 ...
 */
// tested
[[nodiscard]] std::optional<Segment2<Real>> Triangle2<Real>::altitude(const int index) const
{
    NNM_BOUNDS_CHECK_ASSERT("Triangle2<Real>", index >= 0 && index <= 2);
 ...
 */
// tested
[[nodiscard]] std::optional<Circle2<Real>> Triangle2<Real>::circumcircle() const
{
 ...
 */
// tested
[[nodiscard]] std::optional<Circle2<Real>> Triangle2<Real>::incircle() const
{
 ...
 */
// tested
[[nodiscard]] Segment2<Real> Rectangle2<Real>::edge_nx() const
{
 ...
 */
// tested
[[nodiscard]] Segment2<Real> Rectangle2<Real>::edge_ny() const
{
 ...
 */
// tested
[[nodiscard]] Segment2<Real> Rectangle2<Real>::edge_px() const
{
 ...
 */
// tested
[[nodiscard]] Segment2<Real> Rectangle2<Real>::edge_py() const
{
 ...
 */
// tested
[[nodiscard]] Real Rectangle2<Real>::signed_distance(const Point2<Real>& point) const
{
 ...
 */
// tested
constexpr AlignedRectangle2<Real> AlignedRectangle2<Real>::from_bounding_segment(const Segment2<Real>& segment)
{
 ...
 */
// tested
constexpr AlignedRectangle2<Real> AlignedRectangle2<Real>::from_bounding_circle(const Circle2<Real>& circle)
{
 ...
 */
// tested
constexpr AlignedRectangle2<Real> AlignedRectangle2<Real>::from_bounding_triangle(const Triangle2<Real>& triangle)
{
 ...
 */
// tested
AlignedRectangle2<Real> AlignedRectangle2<Real>::from_bounding_rectangle(const Rectangle2<Real>& rectangle)
{
    Point2<Real> min { std::numeric_limits<Real>::max(), std::numeric_limits<Real>::max() };
    Point2<Real> max { std::numeric_limits<Real>::lowest(), std::numeric_limits<Real>::lowest() };
 ...
 */
// tested
[[nodiscard]] constexpr Segment2<Real> AlignedRectangle2<Real>::edge_nx() const
{
    return { vertex_nx_ny(), vertex_nx_py() };
}
 ...
 */
// tested
[[nodiscard]] constexpr Segment2<Real> AlignedRectangle2<Real>::edge_ny() const
{
    return { vertex_nx_ny(), vertex_px_ny() };
}
 ...
 */
// tested
[[nodiscard]] constexpr Segment2<Real> AlignedRectangle2<Real>::edge_px() const
{
    return { vertex_px_ny(), vertex_px_py() };
}
 ...
 */
// tested
[[nodiscard]] constexpr Segment2<Real> AlignedRectangle2<Real>::edge_py() const
{
    return { vertex_nx_py(), vertex_px_py() };
}
 ...
 */
// tested
[[nodiscard]] Real AlignedRectangle2<Real>::signed_distance(const Point2<Real>& point) const
{
    const std::array<Segment2<Real>, 4> edges { edge_nx(), edge_ny(), edge_px(), edge_py() };
    Real min_dist = std::numeric_limits<Real>::max();
    for (const Segment2<Real>& edge : edges) {
