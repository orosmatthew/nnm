...
inline void intersections3_tests()
{
    ...
    test_section("Intersections3(const Vector3&)");
    {
        ...
        TEST_ASSERT(i.contains({ 1.0f, -2.0f, 3.0f }));
    }
    ...
    test_section("Intersections3(const Vector3&, const Vector3&)");
    {
        ...
        TEST_ASSERT(i.contains({ 1.0f, -2.0f, 3.0f }) && i.contains({ -3.0, 4.0f, -5.0f }));
    }
    ...
    test_section("insert");
    {
        ...
        TEST_ASSERT(i1_copy.approx_equal({ { 1.5f, -2.5f, 3.5f } }));
        auto i2_copy = i2;
        i2_copy.insert({ 1.5f, -2.5f, 3.5f });
        TEST_ASSERT(i2_copy.approx_equal({ { 1.0f, -2.0f, 3.0f }, { 1.5f, -2.5f, 3.5f } }));
        i2_copy = i2;
    ...
    {
        TEST_ASSERT(nnm::Intersections3f::capacity() == 2);
    }
    ...
    test_section("approx_equal");
    {
        ...
        TEST_ASSERT(i2.approx_equal({ { 1.0f, -2.0f, 3.0f } }));
        TEST_ASSERT_FALSE(i2.approx_equal(i1));
        TEST_ASSERT_FALSE(i2.approx_equal(i3));
        TEST_ASSERT(i3.approx_equal({ { 1.0f, -2.0f, 3.0f }, { -3.0f, 4.0f, -5.0f } }));
        TEST_ASSERT(i3.approx_equal({ { -3.0f, 4.0f, -5.0f }, { 1.0f, -2.0f, 3.0f } }));
    ...
    test_section("contains");
    {
        ...
        TEST_ASSERT(i2.contains({ 1.0f, -2.0f, 3.0f }));
        TEST_ASSERT_FALSE(i2.contains({ -3.0f, 4.0f, -5.0f }));
        TEST_ASSERT(i3.contains({ 1.0f, -2.0f, 3.0f }));
        TEST_ASSERT(i3.contains({ -3.0f, 4.0f, -5.0f }));
        TEST_ASSERT_FALSE(i3.contains({ 1.5f, -2.5f, 3.5f }));
    }
    ...
    test_section("operator==");
    {
        ...
        TEST_ASSERT(i2 == nnm::Intersections3f({ 1.0f, -2.0f, 3.0f }));
        TEST_ASSERT_FALSE(i2 == i1);
        TEST_ASSERT_FALSE(i2 == i3);
        TEST_ASSERT(i3 == nnm::Intersections3f({ 1.0f, -2.0f, 3.0f }, { -3.0f, 4.0f, -5.0f }));
        TEST_ASSERT(i3 == nnm::Intersections3f({ -3.0f, 4.0f, -5.0f }, { 1.0f, -2.0f, 3.0f }));
    ...
    test_section("operator!=");
    {
        ...
        TEST_ASSERT_FALSE(result);
        TEST_ASSERT(i1 != i2);
        TEST_ASSERT_FALSE(i2 != nnm::Intersections3f({ 1.0f, -2.0f, 3.0f }));
        TEST_ASSERT(i2 != i1);
        TEST_ASSERT(i2 != i3);
        TEST_ASSERT_FALSE(i3 != nnm::Intersections3f({ 1.0f, -2.0f, 3.0f }, { -3.0f, 4.0f, -5.0f }));
        TEST_ASSERT_FALSE(i3 != nnm::Intersections3f({ -3.0f, 4.0f, -5.0f }, { 1.0f, -2.0f, 3.0f }));
        TEST_ASSERT(i3 != i1);
        TEST_ASSERT(i3 != i2);
    }
}
...
inline void triangle3_tests()
{
    ...
    test_section("Triangle3()");
    {
        ...
        TEST_ASSERT(t1.vertices[0].approx_equal(nnm::Vector3f::zero()));
        TEST_ASSERT(t1.vertices[1].approx_equal(nnm::Vector3f::zero()));
        TEST_ASSERT(t1.vertices[2].approx_equal(nnm::Vector3f::zero()));
    }
    ...
    test_section("intersection(const Plane&)");
    {
        ...
        TEST_ASSERT(i5.has_value() && i5->coincident({ nnm::Vector3f::zero(), nnm::Vector3f::zero() }))
...
void sphere_tests()
{
    ...
    test_section("surface_intersections(const Ray3&)");
    {
        ...
        TEST_ASSERT(r6.approx_equal({ nnm::Vector3f::zero() }));
    ...
    test_section("surface_intersections(const Segment3&)");
    {
        ...
        TEST_ASSERT(r7.approx_equal({ nnm::Vector3f::zero() }));
