...
int main()
{
    ...
    test_case("Vector2");
    {
        ...
        test_section("all");
        {
            const auto all_threes = nnm::Vector2f::all(3.0f);
        ...
        test_section("zero");
        {
            const auto zero = nnm::Vector2f::zero();
            ASSERT(zero.x == 0.0f);
            ASSERT(zero.y == 0.0f);
        }
        ...
        test_section("one");
        {
            const auto one = nnm::Vector2f::one();
            ASSERT(one.x == 1.0f);
            ASSERT(one.y == 1.0f);
        }
        ...
        test_section("axis_x");
        {
            const auto x = nnm::Vector2f::axis_x();
            ASSERT(x.x == 1.0f);
            ASSERT(x.y == 0.0f);
        }
        ...
        test_section("axis_y");
        {
            const auto y = nnm::Vector2f::axis_y();
            ASSERT(y.x == 0.0f);
            ASSERT(y.y == 1.0f);
        }
    ...
    test_case("Vector3");
    {
        ...
        test_section("all");
        {
            const auto v1 = nnm::Vector3f::all(3.0f);
            ASSERT(v1.x == 3.0f);
            ASSERT(v1.y == 3.0f);
            ASSERT(v1.z == 3.0f);
        }
        ...
        test_section("zero");
        {
            const auto v2 = nnm::Vector3f::zero();
            ASSERT(v2.x == 0.0f);
            ASSERT(v2.y == 0.0f);
            ASSERT(v2.z == 0.0f);
        }
        ...
        test_section("one");
        {
            const auto v3 = nnm::Vector3f::one();
            ASSERT(v3.x == 1.0f);
            ASSERT(v3.y == 1.0f);
            ASSERT(v3.z == 1.0f);
        }
        ...
        test_section("axis_x");
        {
            const auto x = nnm::Vector3f::axis_x();
            ASSERT(x.x == 1.0f);
            ASSERT(x.y == 0.0f);
            ASSERT(x.z == 0.0f);
        }
        ...
        test_section("axis_y");
        {
            const auto y = nnm::Vector3f::axis_y();
            ASSERT(y.x == 0.0f);
            ASSERT(y.y == 1.0f);
            ASSERT(y.z == 0.0f);
        }
        ...
        test_section("axis_z");
        {
            const auto z = nnm::Vector3f::axis_z();
            ASSERT(z.x == 0.0f);
            ASSERT(z.y == 0.0f);
            ASSERT(z.z == 1.0f);
        }
        ...
        test_section("cross");
        {
            const nnm::Vector3 v1(1.0f, -2.0f, 3.0f);
            const nnm::Vector3 v2(-2.0f, 4.0f, -6.0f);
            ASSERT(v1.cross(v2) == nnm::Vector3f::zero());
            const nnm::Vector3 v3(1.0f, 2.0f, 3.0f);
    ...
    test_case("Vector4");
    {
        ...
        test_section("all");
        {
            const auto v1 = nnm::Vector4f::all(3.0f);
            ASSERT(v1.x == 3.0f);
            ASSERT(v1.y == 3.0f);
            ASSERT(v1.z == 3.0f);
            ASSERT(v1.w == 3.0f);
        ...
        test_section("zero");
        {
            const auto v2 = nnm::Vector4f::zero();
            ASSERT(v2.x == 0.0f);
            ASSERT(v2.y == 0.0f);
            ASSERT(v2.z == 0.0f);
            ASSERT(v2.w == 0.0f);
        ...
        test_section("one");
        {
            const auto v3 = nnm::Vector4f::one();
            ASSERT(v3.x == 1.0f);
            ASSERT(v3.y == 1.0f);
            ASSERT(v3.z == 1.0f);
            ASSERT(v3.w == 1.0f);
        ...
        test_section("axis_x");
        {
            const auto x = nnm::Vector4f::axis_x();
            ASSERT(x.x == 1.0f);
            ASSERT(x.y == 0.0f);
            ASSERT(x.z == 0.0f);
            ASSERT(x.w == 0.0f);
        ...
        test_section("axis_y");
        {
            const auto y = nnm::Vector4f::axis_y();
            ASSERT(y.x == 0.0f);
            ASSERT(y.y == 1.0f);
            ASSERT(y.z == 0.0f);
            ASSERT(y.w == 0.0f);
        ...
        test_section("axis_z");
        {
            const auto z = nnm::Vector4f::axis_z();
            ASSERT(z.x == 0.0f);
            ASSERT(z.y == 0.0f);
            ASSERT(z.z == 1.0f);
            ASSERT(z.w == 0.0f);
        ...
        test_section("axis_w");
        {
            const auto w = nnm::Vector4f::axis_w();
            ASSERT(w.x == 0.0f);
            ASSERT(w.y == 0.0f);
            ASSERT(w.z == 0.0f);
            ASSERT(w.w == 1.0f);
    ...
    test_case("Matrix2");
    {
        ...
        test_section("all");
        {
            const auto mat_all_three = nnm::Matrix2f::all(3.0f);
        ...
        test_section("zero");
        {
            const auto mat_zero = nnm::Matrix2f::zero();
        ...
        test_section("one");
        {
            const auto mat_one = nnm::Matrix2f::one();
        ...
        test_section("identity");
        {
            const auto mat_identity = nnm::Matrix2f::identity();
    ...
    test_case("Basis2");
    {
        ...
        {
            const auto b1 = nnm::Basis2f::from_scale({ 2.0f, -3.0f });
        ...
        {
            const nnm::Basis2 b1;
            const auto b2 = nnm::Basis2(nnm::Matrix2f::zero());
        ...
        test_section("rotate");
        {
            ...
            const auto b2 = nnm::Basis2f::from_scale({ 2.0f, 0.5f });
    ...
    test_case("Matrix3");
    {
        ...
        test_section("all");
        {
            const auto threes = nnm::Matrix3f::all(3.0f);
        ...
        test_section("zero");
        {
            const auto zeros = nnm::Matrix3f::zero();
        ...
        test_section("one");
        {
            const auto ones = nnm::Matrix3f::one();
        ...
        test_section("identity");
        {
            const auto identity_mat = nnm::Matrix3f::identity();
    ...
    test_case("Matrix4");
    {
        ...
        test_section("all");
        {
            const auto m1 = nnm::Matrix4f::all(3.0f);
        ...
        test_section("zero");
        {
            const auto m2 = nnm::Matrix4f::zero();
        ...
        test_section("one");
        {
            const auto m3 = nnm::Matrix4f::one();
            ASSERT(m3.col0_row0 == 1.0f);
        ...
        test_section("identity");
        {
            const auto m4 = nnm::Matrix4f::identity();
