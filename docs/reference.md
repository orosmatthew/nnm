...
bool approx_greater(Real a, Real b);
bool approx_less_equal(Real a, Real b);
bool approx_greater_equal(Real a, Real b);
bool approx_less_zero(Real value);
bool approx_greater_zero(Real value);
bool approx_less_equal_zero(Real value);
bool approx_greater_equal_zero(Real value);
...
bool parallel_to(const Vector2& other) const;
bool perpendicular_to(const Vector2& other) const;
...
bool parallel_to(const Vector2i& other) const;
bool perpendicular_to(const Vector2i& other) const;
...
bool parallel_to(const Vector3& other) const;
bool perpendicular_to(const Vector3& other) const;
...
bool parallel_to(const Vector3i& other) const;
bool perpendicular_to(const Vector3i& other) const;
