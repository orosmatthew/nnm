...
bool parallel(const Vector2& other) const;
bool perpendicular(const Vector2& other) const;
...
uint8_t abs_max_index() const;
uint8_t min_index() const;
uint8_t abs_min_index() const;
...
bool perpendicular(const Vector3& other) const;
