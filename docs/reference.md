...
int max(int a, int b);
bool approx_zero(float value, float epsilon = nnm::epsilon);
bool approx_lte(float a, float b, float epsilon);
bool approx_equal(float a, float b, float epsilon = nnm::epsilon);
bool approx_gte(float a, float b, float epsilon);
